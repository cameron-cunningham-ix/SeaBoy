...
BLARGG_ROMS=(
    ...
    "roms/blargg/cpu/01-special.gb"
    "roms/blargg/cpu/02-interrupts.gb"
    "roms/blargg/cpu/03-op sp,hl.gb"
    "roms/blargg/cpu/04-op r,imm.gb"
    "roms/blargg/cpu/05-op rp.gb"
    "roms/blargg/cpu/06-ld r,r.gb"
    "roms/blargg/cpu/07-jr,jp,call,ret,rst.gb"
    "roms/blargg/cpu/08-misc instrs.gb"
    "roms/blargg/cpu/09-op r,r.gb"
    "roms/blargg/cpu/10-bit ops.gb"
    "roms/blargg/cpu/11-op a,(hl).gb"
